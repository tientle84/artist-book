...
const ICON_PLAY_BUTTON = new Icon(require("./images/play_button.png"), 34, 51);
const ICON_PAUSE_BUTTON = new Icon(
    require("./images/pause_button.png"),
    34,
    51
);
const ICON_STOP_BUTTON = new Icon(require("./images/stop_button.png"), 22, 22);
const ICON_FORWARD_BUTTON = new Icon(
    require("./images/forward_button.png"),
    33,
    25
);
const ICON_BACK_BUTTON = new Icon(require("./images/back_button.png"), 33, 25);

const ICON_LOOP_ALL_BUTTON = new Icon(
    require("./images/loop_all_button.png"),
    77,
    35
);
const ICON_LOOP_ONE_BUTTON = new Icon(
    require("./images/loop_one_button.png"),
    77,
    35
);

const ICON_MUTED_BUTTON = new Icon(
    require("./images/muted_button.png"),
    67,
    58
);
const ICON_UNMUTED_BUTTON = new Icon(
    require("./images/unmuted_button.png"),
    67,
    58
);

const ICON_TRACK_1 = new Icon(require("./images/track_1.png"), 166, 5);
const ICON_THUMB_1 = new Icon(require("./images/thumb_1.png"), 18, 19);
const ICON_THUMB_2 = new Icon(require("./images/thumb_2.png"), 15, 19);
...
export default class App extends React.Component {
    ...
    componentDidMount() {
        ...
        (async () => {
            await Font.loadAsync({
                ...MaterialIcons.font,
                "cutive-mono-regular": require("./fonts/CutiveMono-Regular.ttf"),
            });
    ...
    _onReadyForDisplay = (event) => {
        ...
        if (widestHeight > VIDEO_CONTAINER_HEIGHT) {
            ...
            this.setState({
                videoWidth: DEVICE_WIDTH,
                videoHeight:
                    (DEVICE_WIDTH * event.naturalSize.height) /
    ...
    _trySetRate = async (rate, shouldCorrectPitch) => {
        if (this.playbackInstance != null) {
            try {
                await this.playbackInstance.setRateAsync(
                    rate,
                    shouldCorrectPitch
                );
            } catch (error) {
                ...
                >
                    ...
                    >
                        <Image
                            style={styles.button}
                            source={
                                LOOPING_TYPE_ICONS[this.state.loopingType]
                                    .module
                            }
                        />
                    </TouchableHighlight>
